...
import '../../../../view/profile/login.dart';
import '../../../data/dt.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                // Navigate to the login page when "Switch to Other Account" is pressed
    ...
    child: Row(
      ...
      children: [
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Horodinca Rares", style: AppThemes.profileDevName),
            Text(
              "Student",
              style: TextStyle(
                  fontSize: 17,
