...
class _BodyState extends State<Body> {
            ...
            child: Row(
              children: List.generate(
                ...
                (index) {
                  ...
                  if (selectedIndexOfCategory == 0 &&
                      model.name.toLowerCase().contains('nike')) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                      ...
                      child: buildShoeContainer(width, height, model),
                    );
                  } else if (selectedIndexOfCategory == 1 &&
                      model.name.toLowerCase().contains('adidas')) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                  ...
                  } else if (selectedIndexOfCategory == 2 &&
                      model.name.toLowerCase().contains('puma')) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
  ...
  // Helper method to build a shoe container
  Widget buildShoeContainer(double width, double height, ShoeModel model) {
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: IconButton(
              onPressed: () {
                // Scroll to the next set of shoes
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (ctx, index) {
            ...
            if (selectedIndexOfCategory == 0 &&
                model.name.toLowerCase().contains('nike')) {
              return buildShoeItem(width, height, model);
            } else if (selectedIndexOfCategory == 1 &&
                model.name.toLowerCase().contains('adidas')) {
              return buildShoeItem(width, height, model);
            } else if (selectedIndexOfCategory == 2 &&
  ...
  // Helper method to build a shoe item
  Widget buildShoeItem(double width, double height, ShoeModel model) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
      ...
      child: Container(
        ...
        width: width / 2.24, // Adjust the width to center the shoes
        height: height / 4.3,
        decoration: BoxDecoration(
